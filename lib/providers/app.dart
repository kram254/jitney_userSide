...
import 'package:jitney_userSide/services/ride_requests.dart';
import 'package:jitney_userSide/widgets/custom_btn.dart';
import 'package:jitney_userSide/widgets/custom_txt.dart';
import 'package:jitney_userSide/widgets/stars.dart';
        ...
        if (doc.doc.data()['id'] == id) {
          ...
          switch (doc.doc.data()['status']) {
            ...
            case ACCEPTED:
              ...
              driverModel = await _driverService.getDriverById(doc.doc.data()['driverId']);
